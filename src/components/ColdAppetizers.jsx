...
import appetizersData from "../locales/cold_appetizers.json";
import { style } from "../utils/styles";
import { xolodnie1, xolodnie2 } from "../assets";
  ...
  return (
    <div className={`${style.flexCol} items-center sm:py-20 py-16 px-4 w-full`}>
      ...
      <div className={`${style.flexArround} w-full my-6`}>
        <img className="sm:w-[45%] w-full" src={xolodnie1} alt="salad" />
        <img className="sm:w-[45%] w-full" src={xolodnie2} alt="salad" />
      </div>
    </div>
  );
};
