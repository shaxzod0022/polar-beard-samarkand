    ...
    <>
      ...
      >
        <h2 className="sm:text-[50px] text-[35px] text-blue-950 uppercase font-bold mb-4 text-center">
          {meatData.beef_courses.title[language]}
        </h2>
        <div className={`${style.flexCol} gap-8 md:w-[80%] w-full`}>
          {meatData.beef_courses.dishes.map((salad, index) => (
      ...
      >
        <h2 className="sm:text-[50px] text-[35px] text-blue-950 uppercase font-bold mb-4 text-center">
          {meatData.chicken_courses.title[language]}
        </h2>
        <div className={`${style.flexCol} gap-8 md:w-[80%] w-full`}>
          {meatData.chicken_courses.dishes.map((salad, index) => (
            <div key={index} className={`${style.flexBetween} font-titleFont`}>
              <div>
                <p className="font-semibold md:leading-10 sm:leading-7 leading-5  visible md:text-[40px] sm:text-[30px] text-[22px]">
                  {salad.name[language]}
      ...
      >
        <h2 className="sm:text-[50px] text-[35px] text-blue-950 uppercase font-bold mb-4 text-center">
          {meatData.lamb_courses.title[language]}
        </h2>
        <div className={`${style.flexCol} gap-8 md:w-[80%] w-full`}>
          {meatData.lamb_courses.dishes.map((salad, index) => (
            <div key={index} className={`${style.flexBetween} font-titleFont`}>
              <div>
                <p className="font-semibold md:leading-10 sm:leading-7 leading-5  visible md:text-[40px] sm:text-[30px] text-[22px]">
                  {salad.name[language]}
        ...
        <div className={`${style.flexArround} w-full my-6`}>
          <img className="sm:w-[45%] w-full" src={vtoroy1} alt="salad" />
          <img className="sm:w-[45%] w-full" src={vtoroy2} alt="salad" />
        </div>
      </div>
    </>
  );
